...
exports.signup = async (req, res) => {
  try {
    ...
    const checkQuery = 'SELECT * FROM users WHERE username = ? ALLOW FILTERING'; // Place ALLOW FILTERING correctly
...
exports.login = async (req, res) => {
  try {
    ...
    const query = 'SELECT * FROM users WHERE username = ? ALLOW FILTERING'; // Place ALLOW FILTERING correctly
